...
export function HeroSection({ settings }: { settings?: any }) {
  const hero = settings?.hero || {
    badgeTag: 'NEXT-GEN',
    badgeText: 'AI-Powered Digital Agency',
    headingLine1: 'Smarter Digital.',
    headingLine2: 'Stronger Brands.',
    subheading:
      "We're BrainForge26 — the AI-fueled enterprise software company that blends creativity, code, and strategy to build solutions impossible to ignore.",
    primaryCtaText: 'Start Your Project',
    primaryCtaUrl: '/contact',
    secondaryCtaText: 'See Our Process',
    secondaryCtaUrl: '/services',
    statsCount: '2000+ Happy Clients',
  };
  ...
  return (
    <div className="relative min-h-screen bg-[#050608] text-white overflow-hidden pt-36 pb-20 flex flex-col justify-center">
      ...
      {/* Subtle bottom orange accent glow line matching reference image */}
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              <span className="px-2.5 py-1 rounded-full bg-white text-slate-950 font-black text-[10px] uppercase tracking-wider flex items-center gap-1">
                ...
                {hero.badgeTag || 'NEXT-GEN'}
              </span>
              <span className="text-slate-300 font-semibold">{hero.badgeText}</span>
            </motion.div>
            ...
            >
              <Link href={hero.primaryCtaUrl || '/contact'}>
              ...
              <Link href={hero.secondaryCtaUrl || '/services'}>
                <button className="px-8 py-4 rounded-2xl bg-white/[0.04] hover:bg-white/[0.09] border border-white/[0.15] text-white font-bold text-sm backdrop-blur-md transition-all flex items-center gap-3">
                  <span>{hero.secondaryCtaText || 'See Our Process'}</span>
                  <ArrowRight className="w-4 h-4" />
                </button>
              </Link>
            </motion.div>
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/[0.15] bg-[#0A0C14]/80 shadow-[0_25px_60px_rgba(0,0,0,0.9)] backdrop-blur-xl p-2 transform group-hover:rotate-1 transition-transform duration-500">
                <img
                  ...
                  alt="BrainForge26 Software Platform"
              ...
              <div className="pt-3 border-t border-white/[0.08] flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-xs font-bold text-white tracking-wide">
                    {hero.statsCount || '2000+ Happy Clients'}
                  </span>
                </div>
              </div>
            </motion.div>
