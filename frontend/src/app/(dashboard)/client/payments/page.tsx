...
export default async function ClientPaymentsPage() {
  ...
  return (
    <div className="animate-fade-up space-y-6">
      <PageHeader title="Payments" description="View your payment history and outstanding invoices." />
          ...
          <div className="overflow-x-auto">
            <table className="premium-table">
              ...
              <tbody>
                {payments.length === 0 && (
                  <tr>
                    <td colSpan={7} className="px-6 py-8 text-center text-sm text-[#7A8499]">No payments found.</td>
                  </tr>
                )}
