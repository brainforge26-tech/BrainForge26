      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h1 className="text-4xl sm:text-6xl font-extrabold text-white mt-4 tracking-tight">
            Let's Build Something <span className="bg-clip-text text-transparent bg-gradient-to-r from-orange-400 via-amber-400 to-orange-500">Extraordinary</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start max-w-6xl mx-auto">
          ...
          <div className="space-y-8 lg:col-span-1">
            <div className="p-8 rounded-3xl bg-[#0B1224] border border-white/[0.08] backdrop-blur-xl shadow-xl space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@brainforge26.tech" className="text-sm font-semibold text-white hover:text-orange-400 transition-colors">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+18005550199" className="text-sm font-semibold text-white hover:text-orange-400 transition-colors">
                    +1 (800) 555-0199
                  </a>
                </div>
              </div>
          ...
          {/* Contact Form */}
          <div className="lg:col-span-2 p-8 lg:p-10 rounded-3xl bg-[#0B1224] border border-white/[0.08] backdrop-blur-xl shadow-2xl">
            <h3 className="text-2xl font-bold text-white mb-2">Send Us A Message</h3>
            <p className="text-xs text-slate-300 mb-8">Fill out the form below and an engineering consultant will reach out shortly.</p>
            ...
            <form action={submitContactAction} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-white/[0.05] border border-white/[0.1] text-white text-sm focus:outline-none focus:border-orange-400 transition-colors"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    name="service"
                    className="w-full px-4 py-3 rounded-xl bg-[#090D16] border border-white/[0.1] text-white text-sm focus:outline-none focus:border-orange-400 transition-colors"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/[0.05] border border-white/[0.1] text-white text-sm focus:outline-none focus:border-orange-400 transition-colors resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full py-4 rounded-xl bg-gradient-to-r from-orange-500 via-amber-500 to-orange-600 hover:from-orange-400 hover:to-amber-400 text-white font-black text-sm shadow-xl flex items-center justify-center gap-2 transition-all hover:scale-[1.01]"
              >
