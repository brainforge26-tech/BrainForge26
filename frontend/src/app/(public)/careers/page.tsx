  ...
  return (
    <div className="min-h-screen bg-[#060910] text-slate-100 pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Job Listings */}
        {jobs.length === 0 ? (
          <div className="text-center py-16 bg-white/[0.02] border border-white/[0.08] rounded-3xl">
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            {jobs.map((job: any) => (
              <div
                key={job.id}
                className="rounded-3xl bg-[#0B1224] border border-white/[0.08] hover:border-blue-500/40 p-8 backdrop-blur-xl transition-all shadow-xl space-y-6"
              >
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-white/[0.08]">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      <span className="px-3 py-0.5 rounded-full text-xs font-bold bg-blue-600/20 text-cyan-300 border border-blue-500/30">
                        {job.department}
                      </span>
                  ...
                  <Link
                    ...
                    className="px-6 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-bold text-sm transition-all shadow-lg shrink-0 flex items-center gap-2"
                  >
